...
data class AccountBalance(
    ...
    @SerializedName("internet") val internet: Internet? = null,
    @SerializedName("minutes") val minutes: Minutes? = null,
    @SerializedName("roaming_balance") val roamingBalance: RoamingBalance? = null,
    @SerializedName("validity_threshold") val validityThreshold: Int? = null
)